...
type IBll interface {
	...
	Add(model interface{}, uniqueCols string) int
	Delete(model interface{}) int
	Updata(model interface{}, uniqueCols string, cols ...string) int
	RealDelete(model interface{}) int
	QueryOne(model interface{}, cols ...string) bool
	QueryTable(model, list interface{}, where map[string]interface{}, relatedSel []interface{}, orderBy []string, pageSize, pageIndex int, cols ...string) int64
